...
elapsed weeks is probably important, it is the time between survey dates, so if it has been 2 weeks intead of 1, we expect more groth
```{r}
...
```{r}
surv.models.best <- surv.models.best %>% slice_min(BIC, n = 1)
```
...
surv.predictions <- surv.models.best %>%
