...
growth.models <- tribble(
  ...
  "4b_linear_with_survey_date_pops_2way", "height.cm.next ~ height.cm*survey_date_char + height.cm*parent.pop + survey_date_char*parent.pop",
...
growth.models %>% select(-f, -lm) %>% unnest(glance) %>% arrange(AIC)
```
