...
```{r}
#ran this on jetstream m3.xl: 32 CPU, 125GB RAM.  It took most of the ram...maybe can recode it to be more memory efficient.  e.g. only keep last week of data. remove unused columns.
...
# Set up parallel processing with 8 cores
future::plan(future::multisession, workers = 16)

# first generation
# 288 seconds with 16 cores
# 177 seconds with 8 cores
system.time({
...
# 3680 seconds with 16 processors
# 11522.69 with 8 processors(!)
system.time({
