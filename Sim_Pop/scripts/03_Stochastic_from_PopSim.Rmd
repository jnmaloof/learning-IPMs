...
[] recombination / more intellegent handling of genotypic effects in mating
...
generations$seed[[1]] <- calc.geno(simpop, seedPerFruit = 4)

generations$pop[[1]] <- calc.pheno(generations$seed[[1]])

for(i in 2:ngenerations) {
  generations$seed[[i]] <- calc.geno(generations$pop[[i-1]], seedPerFruit=4)
  print(nrow(generations$seed[[i]]))
