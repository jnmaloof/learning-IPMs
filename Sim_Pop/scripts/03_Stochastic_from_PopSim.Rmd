...
calc.geno <- function(pop, size = 2000) {
  ...
  if (n_pop < 2) {
    stop("Need at least 2 individuals with fruit in the population to avoid self-mating")
  }
  
  # Generate parent1 indices
  parent1_indices <- sample.int(n_pop, size, replace = TRUE, prob = prob)
...
ngenerations <- 20 # note: 4 seconds per generation
